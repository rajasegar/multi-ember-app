...
return n.module.exports},loader={__aliases:{},noConflict:function(t){var r,i
for(r in this.__aliases=t,t)t.hasOwnProperty(r)&&n.hasOwnProperty(r)&&(i=t[r],e[i]=e[r],e[r]=n[r])},makeDefaultExport:!0}
var r=t(),i=(t(),0)
...
return n}function Te(e,t){return e.get(t)}function Ae(e,t){return"attrs"===t[0]&&(t.shift(),1===t.length)?Te(e,t[0]):Oe(e,t)}var Se,Ce,Pe=function(e){var t=e.indexOf(":")
if(-1===t)return[e,e,!0]
...
function St(e){return e.capabilities.asyncLifeCycleCallbacks}function Ct(e){return e.capabilities.updateHook}function Pt(e){return e.capabilities.destructor}var xt=new(function(e){function r(){return e.apply(this,arguments)||this}(0,t.inheritsLoose)(r,e)
var o=r.prototype
...
Pt(e)&&e.destroyComponent(t)},e}(),Nt=function(e,t,n,r){this.name=e,this.ComponentClass=t,this.delegate=n,this.template=r,this.manager=xt,this.state={name:e,ComponentClass:t,template:r,delegate:n}},Mt=function(e,t,n){this.manager=e,this.state={ComponentClass:t,layout:n}},jt=function(e){function n(t){var n
...
void 0!==r&&t.set("model",r.value()),g.ENV._DEBUG_RENDER_TREE&&(n.extra.debugRenderTree.update(e),n.extra.debugRenderTree.update(e.controller))},r.didUpdateLayout=function(e,t){g.ENV._DEBUG_RENDER_TREE&&(e.environment.extra.debugRenderTree.didRender(e.controller,t),e.environment.extra.debugRenderTree.didRender(e,t))},n}(pe)),On=function(e){this.manager=Rn,this.state={name:e}}
...
return"string"==typeof r?this._lastName===r?this._lastDef:e.extra.owner.hasRegistration("engine:"+r)?(this._lastName=r,this._lastDef=(0,f.curry)(new On(r),n),this._lastDef):null:(this._lastDef=null,this._lastName=null,null)},t.get=function(){return f.UNDEFINED_REFERENCE},e}(),An=function(){function e(e){this.outletState=e,this.tag=(0,h.createTag)()}var t=e.prototype
...
if(null===a.component?g.ENV._TEMPLATE_ONLY_GLIMMER_COMPONENTS&&(l=new Dt(i,n)):(0,O.isTemplateOnlyComponent)(a.component.class)&&(l=new Dt(i,n)),null!==a.component){var c=a.component.class,f=Fn(c)
...
Object.defineProperty(e,"__esModule",{value:!0}),e.computed=Se,e.isComputed=function(e,t){return Boolean(ee(e,t))},e.getCacheFor=v,e.getCachedValueFor=g,e.peekCacheFor=_,e.alias=function(e){return pe(new xe(e),Pe)},e.deprecateProperty=function(e,t,n,r){Object.defineProperty(e,t,{configurable:!0,enumerable:!1,set:function(e){we(this,n,e)},get:function(){return _e(this,n)}})},e._getPath=Ee,e.get=_e,e.getWithDefault=function(e,t,n){var r=_e(e,t)
...
S.size>0&&S.delete(e)}(e),(0,a.schedule)("destroy",t,Ue),!0},e.addObserver=C,e.activateObserver=x,e.removeObserver=P,e.flushAsyncObservers=function(e){void 0===e&&(e=!0)
...
if(se(t)){var r=pe(new Te([]),Ae)
return r(t[0],t[1],t[2])}return pe(new Te(t),Ae)}var Ce=Se.bind(null)
...
R=E(R)
var O=y.type||(0,o.typeOf)(R),T=this.serializeQueryParam(R,w,O),A=a+":"+g,S={undecoratedDefaultValue:(0,r.get)(u,g),defaultValue:R,serializedDefaultValue:T,serializedValue:T,type:O,urlKey:w,prop:g,scopedPropertyName:A,controllerName:a,route:this,parts:_,values:null,scope:b}
...
return this._super=n,r}return S.add(n),w(n,R(e)),T(n,A(e)),n}var P=Object.prototype.toString,x=Function.prototype.toString,k=Array.isArray,N=Object.keys,M=JSON.stringify,j=/^[\w$]+$/
...
e.NONE=j
var I={"not-handled":!0}
function L(e){return e&&!!e["no-action"]}function D(e){return!e||!e["not-handled"]}function U(e,n){if(!L(n))if(Array.isArray(n))for(var r,i=(0,t.createForOfIteratorHelperLoose)(n);!(r=i()).done;){U(e,r.value)}else"Simple"===n.type?S(e,n):P(e.encoder,e.syntax.program.constants,n)}function B(e,n,i,o){if(!L(i))if(Array.isArray(i))for(var a,s=(0,t.createForOfIteratorHelperLoose)(i);!(a=s()).done;){B(e,n,a.value,o)}else if("Number"===i.type)P(e,o,i)
...
function H(e,t){return{syntax:e,encoder:new ce,meta:t}}var G=new x,Y=["class","id","value","name","type","style","href"],W=["div","span","p","a"]
...
return new Pt(n,r)},e.renderAot=function(e,t,n,r){void 0===r&&(r=$)
...
var r=e.prototype
return r.initialize=function(){return this.pushSimpleBlock(),this},r.debugBlocks=function(){return this.blockStack.toArray()},r.block=function(){return this.blockStack.current},r.popElement=function(){this[S].pop(),this[S].current},r.pushSimpleBlock=function(){return this.pushLiveBlock(new P(this.element))},r.pushUpdatableBlock=function(){return this.pushLiveBlock(new k(this.element))},r.pushBlockList=function(e){return this.pushLiveBlock(new N(this.element,e))},r.pushLiveBlock=function(e,t){void 0===t&&(t=!1)
...
return t.getCapabilities=function(e){return Tt},t.prepareArgs=function(e,t){throw new Error("Unimplemented prepareArgs in SimpleComponentManager")},t.create=function(e,t,n,r,i,o){throw new Error("Unimplemented create in SimpleComponentManager")},t.getSelf=function(e){return $},t.getTag=function(e){throw new Error("Unimplemented getTag in SimpleComponentManager")},t.didRenderLayout=function(e,t){throw new Error("Unimplemented didRenderLayout in SimpleComponentManager")},t.didCreate=function(e){throw new Error("Unimplemented didCreate in SimpleComponentManager")},t.update=function(e,t){throw new Error("Unimplemented update in SimpleComponentManager")},t.didUpdateLayout=function(e,t){throw new Error("Unimplemented didUpdateLayout in SimpleComponentManager")},t.didUpdate=function(e){throw new Error("Unimplemented didUpdate in SimpleComponentManager")},t.getDestructor=function(e){return null},e}()
...
var xt=function(){function e(){this.stack=null,this.positional=new kt,this.named=new Mt,this.blocks=new Lt}var n=e.prototype
...
Fe(this.env,(function(){R(e,e.env),O(e,e.env)}))},e}(),Zt=function(){function e(e,t){void 0===e&&(e=new s.Stack),void 0===t&&(t=[]),this.inner=e,this.js=t}var r=e.prototype
...
return l.hasDrop=r,l},e.printDropTree=function(e){P(R(e))},e.printDrop=P,e.keys=function(e){return Object.keys(e)},e.unwrap=function(e){if(null==e)throw new Error("Expected value to be present")
return e}
...
var n=e[g]||null
if(n)for(var r,i=(0,t.createForOfIteratorHelperLoose)(n);!(r=i()).done;){P(r.value)}console.groupEnd()}e.ListContentsDestructor=C
...
Object.defineProperty(e,"__esModule",{value:!0}),e.bump=function(){a++},e.combine=w,e.createCombinatorTag=R,e.createTag=function(){return new h(0)},e.createUpdatableTag=m,e.isConstTagged=function(e){return e.tag===v},e.isConstTag=g,e.validateTag=l,e.valueForTag=u,e.dirtyTagFor=S,e.tagFor=C,e.setPropertyDidChange=function(e){O=e},e.beginTrackFrame=N,e.endTrackFrame=M,e.consumeTag=j,e.isTracking=function(){return null!==x},e.track=function(e,t){var n
N()
try{e()}finally{n=M()}return n},e.memo=function(e,t){var n=F(e,t),r=function(){return V(n)}
return r[I]=n,r},e.untrack=function(e){k.push(x),x=null
try{e()}finally{x=k.pop()}},e.isConstMemo=function(e){return!!function(e){return I in e}(e)&&z(e[I])},e.createCache=F,e.isConst=z,e.getValue=V,e.trackedData=function(e,t){var n=new WeakMap,r="function"==typeof t
...
void 0!==r&&(p(r),O())}}function C(e,t){if(T(e)){var n=A.get(e)
...
var t=[]
return e.forEach((function(e){return t.push(e)})),w(t)},e}(),x=null,k=[]
function N(){k.push(x),x=new P}function M(){var e=x
return x=k.pop(),e.combine()}function j(e){null!==x&&x.add(e)}var I=o("CACHE_KEY")
...
e=o[0],t=o[1],void 0===(r=o[2])?i=0:s(i=r.pop())||(n=!0===i,i=r.pop())}return[e,t,r,i=parseInt(i,10),n]}var E=0,w=0,R=0,O=0,T=0,A=0,S=0,C=0,P=0,x=0,k=0,N=0,M=0,j=0,I=0,L=0,D=0,U=0,B=0,F=0,V=0,z=function(){function e(e,t){var n=this
...
return r[n]=function(e,n){e?m(u,e):void 0===t?h(u,n):!0===t?h(u,A(arguments)):Array.isArray(t)?h(u,T(arguments,t)):h(u,n)},i?x(u,r,e,this):P(u,r,e,this)}
return n.__proto__=e,n}function P(e,t,n,r){try{n.apply(r,t)}catch(i){m(e,i)}return e}function x(e,t,n,r){return O.all(t).then((function(t){return P(e,t,n,r)}))}function k(e,t){return O.all(e,t)}e.Promise=O,O.cast=l,O.all=function(e,t){return Array.isArray(e)?new _(this,e,!0,t).promise:this.reject(new TypeError("Promise.all must be called with an array"),t)},O.race=function(e,t){var n=new this(c,t)
...
return new D(O,e,!1,t).promise}))}function B(e){throw setTimeout((function(){throw e})),e}function F(e){var t={resolve:void 0,reject:void 0}
...
return new V(O,e,t,n).promise}))}function q(e,t){return O.resolve(e,t)}function H(e,t){return O.reject(e,t)}var G={},Y=function(e){function t(){return e.apply(this,arguments)||this}(0,n.inheritsLoose)(t,e)
var r=t.prototype
...
for(var ge in a("instrument",!0),ve)ve.hasOwnProperty(ge)&&de(ge,ve[ge])}var ye={asap:K,cast:he,Promise:O,EventTarget:i,all:k,allSettled:M,race:j,hash:L,hashSettled:U,rethrow:B,defer:F,denodeify:C,configure:a,on:de,off:me,resolve:q,reject:H,map:z,async:pe,filter:W}
...
var r=function(){function e(t){(function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")})(this,e),loader.__aliases&&loader.__aliases.requirejs?this._entries=t||window[loader.__aliases.requirejs].entries:this._entries=t||requirejs.entries}var t,r,i
...
return 0===t.indexOf(s)&&t.length>s.length?e+":"+t.slice(s.length):void 0},_extractDefaultExport:function(e){var t
...
"undefined"!=typeof document&&(n.p=(r=document.querySelectorAll("script"))[r.length-1].src.replace(/\/[^/]*$/,"/")),e.exports=(i=_eai_d,o=_eai_r,window.emberAutoImportDynamic=function(e){return o("_eai_dyn_"+e)},void i("single-spa-leaked-globals",[],(function(){return n(3)})))},function(e,t,n){var r,i
function o(e){return(o="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}void 0===(i="function"==typeof(r=function(e){"use strict"
function t(e,t){var n=Object.keys(e)
if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e)
t&&(r=r.filter((function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable}))),n.push.apply(n,r)}return n}function n(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function r(e){return(r="function"==typeof Symbol&&"symbol"===o(Symbol.iterator)?function(e){return o(e)}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":o(e)})(e)}Object.defineProperty(e,"__esModule",{value:!0}),e.default=function(e){if("object"!==r(e))throw Error("single-spa-leaked-globals must be called with an 'opts' object")
if(e=function(e){for(var r=1;r<arguments.length;r++){var i=null!=arguments[r]?arguments[r]:{}
r%2?t(i,!0).forEach((function(t){n(e,t,i[t])})):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(i)):t(i).forEach((function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(i,t))}))}return e}({},i,{},e),!Array.isArray(e.globalVariableNames)||e.globalVariableNames.some((function(e){return"string"!=typeof e})))throw Error("single-spa-leaked-globals must be called with a 'globalVariableNames' array of strings")
return{bootstrap:a.bind(null,e),mount:s.bind(null,e),unmount:u.bind(null,e)}}
var i={globalVariableNames:[]}
function a(e,t){return Promise.resolve().then((function(){e.capturedGlobals={},e.globalVariableNames.forEach((function(t){e.capturedGlobals[t]=window[t]}))}))}function s(e,t){return Promise.resolve().then((function(){e.globalVariableNames.forEach((function(t){window[t]=e.capturedGlobals[t]}))}))}function u(e,t){return Promise.resolve().then((function(){e.globalVariableNames.forEach((function(e){delete window[e]}))}))}})?r.apply(t,[t]):r)||(e.exports=i)}])
